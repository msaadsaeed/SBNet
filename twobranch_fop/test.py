...
def read_data(FLAGS):
    ...
    test_file_face = '../data/face/facenet_face_veriflist_test_%s_unseenunheard.csv'%(FLAGS.test)
    test_file_voice = '../data/voice/voice_veriflist_test_%s_unseenunheard.csv'%(FLAGS.test)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='best_facenet_gated_model_alpha_1.00/checkpoint.pth.tar', help='Checkpoints directory.')
    # parser.add_argument('--ckpt', type=str, default='D:/research/UETGen/icassp2022/soft_opl_loss/best_linear/checkpoint.pth.tar', help='Checkpoints directory.')
    parser.add_argument('--dim_embed', type=int, default=128,
                        help='Embedding Size')
    parser.add_argument('--fusion', type=str, default='gated', help='Fusion Type')
    parser.add_argument('--test', type=str, default='random', help='random, G, N, A, GNA')
